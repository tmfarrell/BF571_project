...
### Background and Motivation
  ...
  In addition, I apply a weak causal measure, a time-series method called Granger causality, to the gene and protein expression data in an attempt to build upon the paper's correlation analyses. Using an analogy to neuroinformatics analyses, this methodology suggests an alternative approach to investigating the mRNA-protein relationship and to building mRNA-protein co-expression networks (@friston_functional_2011). 
...
### Future Work
  ...
  See @seth_granger_2015 and @amblard_relation_2012 for review of the use of Granger casaulity in neuroinformatics.
